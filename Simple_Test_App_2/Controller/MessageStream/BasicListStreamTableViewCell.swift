...
class BasicListStreamTableViewCell: UITableViewCell {
    ...
    func configureCell(message: STMMessage) {
    ...
    func configureImage(message: STMMessage) {
    ...
    func configureType(message: STMMessage) {
        switch message.type {
        case .image:
    ...
    func configureTitleLabel(message: STMMessage) {
        ...
        self.titleTextView.textContainer.lineBreakMode = .byWordWrapping
    }
    
    func configureUnreadLabel(message: STMMessage) {
    ...
    func configureDateLabel(message: STMMessage) {
